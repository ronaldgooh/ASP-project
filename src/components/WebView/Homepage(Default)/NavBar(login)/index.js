    ...
    <div>
        <div className='nav-bar-box'>
            <div className='nav-bar-container'>
                <div className='nav-bar-grid'><Link to='/'>Home</Link></div>
            ...
            <div className='nav-bar-container-two'>
                ...
                <div className='nav-bar-grid'><Link to='/login/consumer'>Login/Sign Up</Link></div>
            </div>
        ...
        <div className='nav-bar-box-two'>
            ...
            <div className='nav-bar-container-fourth'>
                <form className='search-bar' action='/login/consumer' >
            ...
            <div className='nav-bar-conatiner-fifth'>
                <Link className='logo-two' to="/login/consumer">
